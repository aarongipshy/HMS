                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">បន្ថែមការកក់
                                <a href="{{url('admin/booking')}}" class="float-right btn btn-success btn-sm">មើលទាំងអស់</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/booking')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        <tr>
                                            <th>ជ្រើសរើសអតិថិជន<span class="text-danger">*</span></th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>កាលបរិច្ឆេទចាកចេញ <span class="text-danger">*</span></th>
                                            <td><input name="checkout_date" type="date" class="form-control" /></td>
                                        </tr>
                                        <tr>
                                            <th>បន្ទប់ដែលនៅទំនេរ <span class="text-danger">*</span></th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>ចំនួនកុមារសរុប <span class="text-danger">*</span></th> </th>
