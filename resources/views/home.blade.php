...
<div class="container my-4">
	<h1 class="text-center border-bottom" id="services">សេវាកម្ម</h1>
	...
	<div class="row my-4">
		...
		<div class="col-md-8">
			...
			<p>
				<a href="{{url('service/'.$service->id)}}" class="btn btn-primary">អានបន្ថែម</a>
			</p>
		</div>
	</div>
	@endforeach
...
<div class="container my-4">
	<h1 class="text-center border-bottom" id="gallery">រូបភាព</h1>
	<div class="row my-4">
...
<h1 class="text-center mt-5" id="gallery">មតិអតិថិជន</h1>
<br>
...
<!-- LightBox css -->
<link rel="stylesheet" type="text/css" href="{{asset('public/vendor')}}/lightbox2/dist/css/lightbox.min.css" />
<!-- LightBox Js -->
<script type="text/javascript" src="{{asset('public/vendor')}}/lightbox2/dist/js/lightbox.min.js"></script>
<style type="text/css">
	.hide {
		display: none;
	}
